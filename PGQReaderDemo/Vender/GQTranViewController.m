...
#import "GQTranViewController.h"

@interface GQTranViewController ()

/**
 *  左拉右拉手势
 */
@property (nonatomic,strong,nonnull) UIPanGestureRecognizer *pan;

/**
 *  点击手势
 */
@property (nonatomic,strong,nonnull) UITapGestureRecognizer *tap;
...
@implementation GQTranViewController
    ...
    if (self.tempController) {
        ...
        if (self.isLeft) { // 左边
            ...
            if (animated) {
                ...
                __weak GQTranViewController *weakSelf = self;
